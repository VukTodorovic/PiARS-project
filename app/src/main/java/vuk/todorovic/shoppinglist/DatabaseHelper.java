...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<ShoppingList> loadLists(String username) {
        ...
        while (cursor.moveToNext()) {
            ...
            lists.add(new ShoppingList(cursor.getString(cursor.getColumnIndexOrThrow("creator")), cursor.getString(cursor.getColumnIndexOrThrow("title")), (cursor.getInt(cursor.getColumnIndexOrThrow("shared")) == 1)));
    ...
    public ArrayList<ShoppingList> loadMyLists(String username) {
    ...
    public ArrayList<Article> loadTasks(String list) {
        ...
        while (cursor.moveToNext()) {
            ...
            tasks.add(new Article(cursor.getString(cursor.getColumnIndexOrThrow("list")),cursor.getString(cursor.getColumnIndexOrThrow("id")), cursor.getString(cursor.getColumnIndexOrThrow("title")), (cursor.getInt(cursor.getColumnIndexOrThrow("checked")) == 1)));
        }
    ...
    public ArrayList<Article> loadFilteredTasks(String list) {
        ArrayList<Article> tasks = new ArrayList<>();
