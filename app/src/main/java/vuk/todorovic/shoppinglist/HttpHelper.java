...
public class HttpHelper {
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    JSONArray all_tasks = getJSONArrayFromURL("https://piars-server.cyclic.app/tasks/" + owner);
                    ...
                    httpDelete("https://piars-server.cyclic.app/tasks/" + http_id);
    ...
    public void setChecked(String id, boolean check){
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                try{
                    String putUrl = "https://piars-server.cyclic.app/tasks/" + id;
    ...
    public void addTask(String title, String list, String id){
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                try{
                    String addTaskUrl = "https://piars-server.cyclic.app/tasks";
    ...
    public void removeList(String owner, String title){
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    String deleteUrl = "https://piars-server.cyclic.app/lists";
